...
let dropText = dropArea.querySelector(".description");
...
function showImage() {
    ...
    if (validExtensions.includes(fileType)) { //if user selected file is an image file
        ...
        fileReader.onload = () => {
            ...
            dropArea.querySelector("#profile_image_placeholder").setAttribute()//adding that created img tag inside dropArea container
        }
