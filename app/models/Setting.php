...
class Setting {
    ...
    public function addAdminDetails($data){
        $this->db->query('INSERT INTO admin_details 
        (admin_name, admin_email, admin_phone, admin_password, admin_nic, admin_date_assigned) 
        VALUES(:admin_name, :admin_email, :admin_phone, :admin_password, :admin_nic, :admin_date_assigned)');
