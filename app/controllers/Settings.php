    ...
    class Settings extends Controller {
        ...
        public function add_new_admin(){
            ...
            if($_SERVER['REQUEST_METHOD'] == 'POST'){
                ...
                && empty($data['admin_nic_err']) && empty($data['admin_date_assigned_err'])){
                    // Validated

                    // Hash Password
                    $data['admin_password'] = password_hash($data['admin_password'], PASSWORD_DEFAULT);

                    if($this->settingModel->addAdminDetails($data)){
    ...
    public function update_profile(){
        if($_SERVER['REQUEST_METHOD'] == 'GET'){
            ...
            $data = [
                ...
                'admin_phone' => trim($_SESSION['admin_phone']),
                'admin_password' => trim($_SESSION['admin_password']),
                'admin_nic' => trim($_SESSION['admin_nic']),
                'admin_date_assigned' => trim($_SESSION['admin_date_assigned']),
                'admin_name_err' => '',
                'admin_email_err' => '',
                'admin_phone_err' => '',
                'admin_password_err' => '',
