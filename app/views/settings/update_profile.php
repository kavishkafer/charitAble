...
<link rel="stylesheet" href="<?php echo URLROOT; ?>/public/css/add_new_admin.css">
        ...
        <div class="main">
            ...
            <div class="btnBox">
                ...
                <a href="<?php echo URLROOT; ?>/settings/update_profile"><button class="btn active">Update Profile</button></a>
