...
<br>
            ...
            <p class="text"><?php echo $post->body; ?></p>
                ...
                <div class="post-footer">
                    <div class="post-footer">
                        <div class="post-likes" id="post-likes-<?php echo $post->postId;?>">
                            <img src="<?php echo URLROOT;?>/img/postsout/like-btn.png" alt="" class="like-button">
                            <div class="posts-likes-count" id="posts-likes-count-<?php echo $post->postId;?>"><?php echo $post->likes;?></div>
                        </div>

                        <div class="post-dislikes" id="post-dislikes-<?php echo $post->postId;?>">
                            <img src="<?php echo URLROOT;?>/img/postsout/dislike-btn.png" alt="" class="dislike-button">
                            <div class="posts-dislikes-count" id="posts-dislikes-count-<?php echo $post->postId;?>"><?php echo $post->dislikes;?></div>
                        </div>
                    </div>


                    <!-- <div class="post-likes" id="post-likes-<?php echo $post->postId;?>"onclick="addLike(<?php echo $post->postId;?>)"><img src="<?php echo URLROOT;?>img/comments/like-btn.png" alt="">
                         <div class="posts-likes-count" id="posts-likes-count-<?php echo $post->postId;?>"><?php echo $post->likes;?></div>
        ...
        <a href="<?php echo URLROOT; ?>/postsout/show/<?php echo $post->postId; ?>" class="moreLink">More</a>
...
<script type="text/javascript" src="<?php echo URLROOT; ?>/public/js/post/post.js"></script>
    ...
    <script type="text/javascript" src="<?php echo URLROOT; ?>/public/js/posts/postsInteractionsOut.js"></script>
