        ...
        <div class="main">
            ...
            <div class="details">
                <div class="recentOrders">
                    ...
                    <a href="<?php echo URLROOT; ?>/eventHosters/approve_request/<?php echo $data['eventHoster']->E_ID; ?>"><button class="btn_1">Approved</button>
                    <a href="<?php echo URLROOT; ?>/eventHosters/deny_request/<?php echo $data['eventHoster']->E_ID; ?>"><button class="btn_1">Deny</button>
                </div>
            </div>
        </div>
