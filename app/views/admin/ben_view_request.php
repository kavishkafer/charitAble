        ...
        <div class="main">
            ...
            <div class="details">
                <div class="recentOrders">
                    ...
                    <a href="<?php echo URLROOT; ?>/beneficiaries/approve_request/<?php echo $data['beneficiary']->B_Id; ?>"><button class="btn_1">Approved</button>
                    <a href="<?php echo URLROOT; ?>/beneficiaries/deny_request/<?php echo $data['beneficiary']->B_Id; ?>"><button class="btn_1">Deny</button>
