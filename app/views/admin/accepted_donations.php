...
<link rel="stylesheet" href="<?php echo URLROOT; ?>/public/css/admin/topbar.css">
...
<div class="main">
    ...
    try{
        ...
        FROM charitable.donation_table WHERE accepted = 1 AND completed = 0 
